 ...
 *   https://datatables.net/download/#bs-3.3.5/jq-2.1.4,dt-1.10.9,fc-3.1.0,fh-3.0.0,sc-1.3.0
 *
 * Included libraries:
 *   jQuery 2.1.4, Bootstrap 3.3.5, DataTables 1.10.9, FixedColumns 3.1.0, FixedHeader 3.0.0, Scroller 1.3.0
 */
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primero",sLast:"Último",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Mostrando _START_ a _END_ de <span class='label label-info'>_TOTAL_</small> productos",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ productos",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar Producto:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se han encontrado elementos"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
...
jQuery.fn.dataTable.ext.builder = "bs-3.3.5\/jq-2.1.4,dt-1.10.9,fc-3.1.0,fh-3.0.0,sc-1.3.0";
