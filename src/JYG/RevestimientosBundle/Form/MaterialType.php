    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            //->add('tipo','choice', array(
                   // 'choices'  => array('Selecciona'=>'Selecciona un tipo','Laja Natural' => 'Laja Natural', 'Laja Formateada' => 'Laja Formateada','Tablilla Artesanal'=>'Tablilla Artesanal','Quimicos' => 'Quimicos'),
                   // 'label'=>'Tipo de Producto'))
            ->add('tipo','text',array('label' => 'Tipo de Producto'))
            ->add('formato','text',array('label'=>'Formato'))
